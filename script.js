...
const studentInformation = {
  name: "Christy Xiong",
  grade: "A",
  advisor: "Keith Partner",
  major: "Computer Engineering",
  graduationYear: "2024",
  imageUrl: "image/pikachu.png",
}
...
const yearEl = document.querySelector("#student-graduation-year");
...
const fallSemEl = document.querySelector("#fall-semester");
const springSemEl = document.querySelector("#spring-semester");
const winterSemEl = document.querySelector("#winter-term");
...
function updateStudentGraduationYear(graduationYear) {
  // code goes here
  yearEl.innerHTML = graduationYear;
}
...
function updateReportCard(reportCardTableElement, currentSemester) {
  ...
  const course = studentData.currentSemester;
  course.forEach((classes, x) => {addCourseRowToReportCard(reportCardTableElement, classes, x)});
...
function addEventListeners(
  ...
  fallSemesterElement.addEventListeners("click",function(){
    semester = "Fall Semester";
    updateReportCard(reportCardTableElement,semester);
    closeDropdown(dropdownButtonElement);
  })
  springSemesterElement.addEventListeners("click",function(){
    semester = "Spring Semester";
    updateReportCard(reportCardTableElement,semester);
    closeDropdown(dropdownButtonElement);
  })
  winterTermElement.addEventListeners("click",function(){
